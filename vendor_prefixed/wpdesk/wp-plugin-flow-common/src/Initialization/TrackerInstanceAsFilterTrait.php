...
use WPPayVendor\WPDesk\Tracker\OptInOptOut;
/**
...
trait TrackerInstanceAsFilterTrait
{
    ...
    private function register_tracker_ui_extensions()
    {
        ...
        $tracker_ui = new \WPPayVendor\WPDesk\Tracker\OptInOptOut($this->plugin_info->get_plugin_file_name(), $this->plugin_info->get_plugin_slug(), $shop_url, $this->plugin_info->get_plugin_name());
